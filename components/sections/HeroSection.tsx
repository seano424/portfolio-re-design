...
const HeroSection = () => {
	...
	return (
		<section
			id="home"
			className="relative mb-10 flex min-h-[80vh] items-center justify-center lg:mb-0"
		>
			<div className="container grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-0">
				<div className="flex flex-col gap-6">
					<h1
						className={`flex flex-col text-4xl font-black md:text-6xl md:text-gray-900 dark:text-white`}
					>
				...
				<div className="my-10 flex items-center justify-center lg:my-0">
