...
const AboutSection = () => {
	return (
		<section
			className={`${inter.className} container grid gap-6 md:grid-cols-2`}
		>
			<div className="flex flex-col justify-center gap-6 leading-relaxed text-gray-900 dark:text-white">
