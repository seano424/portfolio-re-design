	...
	return (
		<div ref={divRef} className="relative">
			...
			{mounted && isOpen && (
				...
				>
					<div className="flex flex-col items-start rounded-lg bg-white/90 text-nowrap dark:bg-gray-800">
						{themeOptions.map((themeOption) => (
							<button
								...
								className={clsx(
									'flex items-center gap-2 font-mono hover:text-fuchsia-700 dark:hover:text-blue-300',
